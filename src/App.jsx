...
const DEFAULT_MODULES = [
  ...
  { id:'4', type:'benefits', title:'기획전 특가 혜택', benefits:[{icon:'🎁',title:'5,000원 쿠폰',subtitle:'신규가입 고객 한정'},{icon:'⚡',title:'최대 30% 할인',subtitle:'선정 상품'}] },
    ...
    <div style={{marginTop:90,position:'relative',zIndex:1,textAlign:'center',padding:'0 24px',width:'100%'}}>
      {imgLoading ? <>
        ...
        return <div style={{animation:'mmall-fadein 0.6s ease'}}>
          ...
          <div contentEditable suppressContentEditableWarning style={{fontSize:56,fontWeight:800,color:titleColor,letterSpacing:1.2,margin:'16px 0',lineHeight:1.1,fontFamily:font,cursor:'text'}}>{m.title}</div>
...
<div class="wrap">${inner}</div>
  ...
  const generate=async()=>{
    ...
    if(/무료\s*배송|배송\s*무료/.test(txt)) benefitItems.push({icon:'🚚',title:'무료 배송',subtitle:'전 상품'});

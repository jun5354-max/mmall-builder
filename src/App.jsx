...
const DEFAULT_MODULES = [
  ...
  { id:'5', type:'products', tabs:[{id:'tab1',name:'패션'},{id:'tab2',name:'뷰티'}], categories:{ tab1:{ title:'패션 신상품', products:[{brand:'BRAND A',name:'프리미엄 코튼 티셔츠',price:29900,discount:30,img:'/img/image_패션_1.png'},{brand:'BRAND B',name:'슬림핏 데님 팬츠',price:49900,discount:20,img:'/img/image_패션_2.png'},{brand:'BRAND C',name:'캐시미어 니트',price:39900,discount:25,img:'/img/image_패션_3.png'},{brand:'BRAND D',name:'오버핏 셔츠',price:34900,discount:15,img:'/img/image_패션_4.png'}]}, tab2:{ title:'뷰티 추천', products:[{brand:'COSME A',name:'히알루론 에센스',price:19900,discount:20,img:'/img/image_뷰티_1.png'},{brand:'COSME B',name:'수분 크림',price:29900,discount:25,img:'/img/image_뷰티_2.png'},{brand:'COSME C',name:'시카 마스크팩',price:15900,discount:30,img:'/img/image_뷰티_3.png'},{brand:'COSME D',name:'비타민 토너',price:22900,discount:15,img:'/img/image_뷰티_4.png'}]}} },
      ...
      {(imgLoading ? [0,1] : m.benefits||[]).map((_,i)=><div key={i} style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',textAlign:'center',borderRight:i<(imgLoading?1:(m.benefits?.length||1)-1)?'1px solid #e5e5e5':'none'}}>
        {imgLoading ? <>
          ...
          {BENEFIT_ICONS[m.benefits[i].icon]
            ? <div dangerouslySetInnerHTML={{__html:BENEFIT_ICONS[m.benefits[i].icon](mainColor||'#FFE100',lightenHex(mainColor||'#FFE100'))}} style={{width:80,height:80,marginBottom:10}}/>
